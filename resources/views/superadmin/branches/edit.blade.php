...
@section('bread_crumb')
    <ol class="breadcrumb float-sm-right btn btn-default">
            <li class="breadcrumb-item btn btn-outline-success btn-sm "><a href={{ route('super-admin.branches.index') }}>Branches</a></li>            
    </ol>
@endsection
...
@section('main_content')
    ...
    <div class="col-sm-12">
        <form method="post" action="{{ route('super-admin.branches.update', ['branch' => $branch]) }}" >
            @csrf
            @method('PUT')
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="branch_email" name="branch_email"
                            value="{{ $branch->branch_email }}" required>
                        @error('branch_email')
                            <div class="text-sm text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="branch_street_address" name="branch_street_address"
                            value="{{ $branch->branch_street_address }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="branch_city" name="branch_city"
                            value="{{ $branch->branch_city }}" required>
                        @error('branch_city')
                            <div class="text-sm text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="branch_district" name="branch_district"
                            value="{{ $branch->branch_district }}" required>                        
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="branch_postcode" name="branch_postcode"
                            value="{{ $branch->branch_postcode }}" required>                        
