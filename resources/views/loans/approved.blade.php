...
@section('title', 'Approved Loan | ' . $organization->org_name)
@section('page_title', 'Approved Loan')
        ...
        <div class="card card-outline card-success elevation-3 mt-3">
            ...
            <form id="loanForm" method="post" action="{{ route('loans.disburse', ['loan' => $loan]) }}"
                ...
                <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date" id="date-disbursement" data-target-input="nearest">
                                    ...
                                    <input id="disbursement_date" name="disbursement_date" type="text"
                                        ...
                                        data-target="#reservationdate-disbursement" value=""
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" id="approved_period"
                                        name="approved_period" value="{{ $loan->approved_period }}" required>
                                    <div class="input-group-append">
                                        <span class="input-group-text">Months</span>
                                    </div>
                                </div>
                    ...
                    <input type="text" name="status" value="disbursed" required hidden>
                    <input type="text" name="disbursement_officer_id" value="{{ $user->id }}" required hidden>
                    ...
                    <input type="text" name="type" value="Disbursement" required hidden>
                    <input type="text" name="description" value="Loan Disbursement" required hidden>
                    <input type="text" name="loan_product_id" value="{{ $loan_product->id }}" required hidden>
