    ...
    <div class="col-12">
        <div class="form-group">
            <div role="group" class="btn-group">
                <ul class="nav">
                    <li>
                        <a href="{{ route('loans.index') }}" class="btn btn-success">Pending Appraisal</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('loans.deferred') }}"
                            class="btn btn-default btn-success">Deferred</a>
                    </li>
                    <li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-5">
                            <h5 class=""><b><span class="text-success">{{ $organization->currency_code }}</span>
                                ...
                                <span class="btn btn-success btn-xs p-0 ml-2">{{ $loan->branch->branch_name }}</span></h5>
