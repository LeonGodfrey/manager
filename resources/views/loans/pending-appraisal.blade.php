...
@section('main_content')
    ...
    <div class="col-sm-12">
        <div class="card card-outline card-success elevation-3">
            ...
            <div class="card-body ">
                {{-- form --}}
                <form id="loanForm" method="post" action="{{ route('loans.update', ['loan' => $loan]) }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" autocomplete="off" class="form-control thousand-separator"
                                id="application_amount" name="application_amount" value="{{ $loan->application_amount }}"
                                required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group date" id="reservationdate3" data-target-input="nearest">
                                    <div class="input-group-prepend" data-target="#reservationdate3"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" autocomplete="off" min="0"
                                    class="form-control thousand-separator" id="appraisal_amount" name="appraisal_amount"
                                    value="{{ old('appraisal_amount') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="number" autocomplete="off" min="0" class="form-control"
                                    id="appraisal_period" name="appraisal_period" value="{{ old('appraisal_period') }}"
                                    required>
                                <div class="input-group-append">
                                    <span class="input-group-text">Months</span>
                                </div>
