...
@section('page_title', 'New Savings Product')
...
@section('main_content')
    ...
    <div class="col-sm-12">
        <form method="post" action="{{ route('settings.savings-products.store') }}">
            @csrf
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="min_balance" name="min_balance"
                                    value="{{ old('min_balance') }}" required>
                                @error('min_balance')
                                    <div class="text-sm text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="withdrawal_fee" name="withdrawal_fee"
                                    value="{{ old('withdrawal_fee') }}" required>
