...
@section('bread_crumb')
    <ol class="breadcrumb float-sm-right btn btn-default">
        <li class="breadcrumb-item btn btn-outline-success btn-sm "><a href={{ route('settings.loan-products.index') }}>Loan
                Products</a></li>
    </ol>
@endsection
...
@section('main_content')
    ...
    <div class="col-sm-12">
        <form method="post" action="{{ route('settings.loan-products.store') }}">
            @csrf
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control" id="grace_period" name="grace_period"
                                    value="{{ old('grace_period') }}" required>                            
                                @error('grace_period')
                                    <div class="text-sm text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="charge_interest_grace_period"
                                    ...
                                    <option value=" ">--Select If system should charge.</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control" id="arrears_maturity_period"
                                    name="arrears_maturity_period" value="{{ old('arrears_maturity_period') }}" required>
                                <div class="input-group-append">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control" id="max_loan_period" name="max_loan_period"
                                    value="{{ old('max_loan_period') }}" required>
                                <div class="input-group-append">
