...
@section('bread_crumb')
    <ol class="breadcrumb float-sm-right">
        <a href="{{ route('settings.accounts.create') }}" class="btn float-right bg-success"><i class="fa fa-plus"></i> New
            Accounts </a>
    ...
    <div class="col-12">
        <div class="form-group">
            <div role="group" class="btn-group">
                <ul class="nav">
                    <li>
                        <a href="{{ route('settings.accounts.index') }}" class="btn btn-success">Assets</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('settings.accounts.income') }}" class="btn btn-default btn-success">Income</a>
                    </li>
                    <li>
                        <a href="{{ route('settings.accounts.liability') }}"
                            class="btn btn-default btn-success">Liabilities</a>
                    </li>
                </ul>
            </div>
        </div>
