...
@section('title', 'Mobile Money Accounts | ' . $organization->org_name)
@section('page_title', 'Mobile Money Accounts')
        ...
        <div class="form-group">
            <div role="group" class="btn-group">
                <ul class="nav">
                    ...
                    <li>
                        <a href="{{ route('cash-accounts-mobile-money') }}" class="btn btn-success">Mobile Money Accounts</a>
                    </li>
