...
@section('title', 'Vault Accounts | ' . $organization->org_name)
@section('page_title', 'Vault Accounts')
        ...
        <div class="form-group">
            <div role="group" class="btn-group">
                <ul class="nav">
                    ...
                    <li>
                        <a href="{{ route('cash-accounts-bank') }}" class="btn btn-default btn-success">Bank Accounts</a>
                    </li>
                    <li>
                        <a href="{{ route('cash-accounts-vault') }}" class="btn btn-success">Vault Accounts</a>
                    </li>
                    <li>
                        <a href="{{ route('cash-accounts-mobile-money') }}" class="btn btn-default btn-success">Mobile Money Accounts</a>
                    </li>
