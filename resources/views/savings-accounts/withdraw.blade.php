...
@section('title', 'Savings Withdraw | ' . $organization->org_name)
@section('page_title', 'Savings Withdraw')
...
@include('layouts.client-info')
    ...
    <div class="col-sm-12">
        <div class="card card-outline card-success elevation-3 mt-3 mb-5 ">            
            <form id="loanForm" method="post" action="{{ route('savings-accounts.store-withdraw') }}" enctype="multipart/form-data">
                @csrf
