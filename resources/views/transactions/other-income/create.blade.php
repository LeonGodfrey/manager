...
@section('title', 'New Other Income | ' . $organization->org_name)
@section('page_title', 'New Other Income')

@section('bread_crumb')
    <ol class="breadcrumb float-sm-right btn btn-default">
        <a href={{ route('transactions.other-income.index') }}>
            <li class="breadcrumb-item btn btn-outline-success btn-sm ">Other Incomes</li>
        </a>
    </ol>
@endsection
...
@section('main_content')
    ...
    <div class="col-sm-12">
        <form id="loanForm" method="post" action="{{ route('transactions.other-income.store') }}">
            @csrf
            <div class="card card-outline card-success elevation-3">
                <div class=" card-body ">
                    <div class="form-group">
                        <label for="account_id">Other Income Account *</label>
                    ...
                    <div class="form-group">
                        <label for="particular">Name of Client or Particulars *</label>
