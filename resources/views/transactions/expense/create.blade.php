...
@section('title', 'New Expense | ' . $organization->org_name)
@section('page_title', 'New Expense Transaction')

@section('bread_crumb')
    <ol class="breadcrumb float-sm-right btn btn-default">
        <a href={{ route('transactions.expense.index') }}>
            <li class="breadcrumb-item btn btn-outline-success btn-sm ">Expenses</li>
        </a>
    </ol>
@endsection
...
@section('main_content')
    ...
    <div class="col-sm-12">
        <form id="loanForm" method="post" action="{{ route('transactions.expense.store') }}">
            @csrf
            <div class="card card-outline card-success elevation-3">
                <div class=" card-body ">
                        ...
                        <div class="form-group">
                            ...
                            <p class="text-sm m-0">Select the general ledger account against which this transaction will be
                                recorded.</p>
                        ...
                        <div class="form-group">
                            <label for="receipt_number">Voucher Number </label>
                        ...
                        <input type="text" name="type" value="Expense" required hidden>
                ...
                <div class="card-footer">
                    <div class="card-tools text-right pr-5">
                        @if ($cash_account_id)
                            <button name="submit" type="submit" class="btn btn-success">Save Expense</button>
                        @endif
                    </div>
                </div>
            </div>
